...
import { 
  ...
  getRedirectUrl,
  getActionLabel,
  computeTransitMethods
} from "@/lib/travelHelpers";
...
export default function TravelImpactEngine() {
  ...
  const handleExportPDF = () => {
    setVerificationId(Math.random().toString(36).substring(2, 10).toUpperCase());
            ...
            {showRealMap && mapsApiKey ? (
              ...
              <div className="vector-map-canvas">
                <svg 
                  ...
                  role="img"
                  aria-label="Commuter Route Map Diagram. Illustrates origin and destination route points."
                >
                  <title>Commuter route map illustration</title>
                  {/* Water Body Grid */}
                  ...
                  <div className="cert-border-inner">
                    ...
                    <div className="cert-footer">
                      ...
                      <div className="cert-id-tag">
                        ...
                        <strong className="tag-val">{verificationId}</strong>
                      </div>
                    </div>
                  </div>
                </div>
